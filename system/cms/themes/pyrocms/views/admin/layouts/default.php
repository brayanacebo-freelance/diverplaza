...
<body>
	...
	<footer class="clearfix">
		<div class="wrapper">
			<p class="credits">CMS &copy;<?php echo date('Y'); ?> <a href="http://brayanacebo.com" target="_blank">brayanacebo.com</a> &nbsp; <span>Version <?php echo CMS_VERSION.' '.CMS_EDITION; ?> &nbsp; Rendered in {elapsed_time} sec. using {memory_usage}.</span></p>
