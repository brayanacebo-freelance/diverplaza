...
<div id="main_header" style="background-color: #70589e !important;">
    <header>
        <figure id="logo">
...
<h1 class="main_titulos"><?php echo $service->name ?></h1>
<div class="div"></div>
...
<div class="device">
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide"> <img src="<?php echo val_image($image->path) ?>"> </div>
            <?php endforeach; ?>
        </div>
