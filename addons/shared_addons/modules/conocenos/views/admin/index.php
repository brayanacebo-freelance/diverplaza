...
<section class="item">
    <div class="content">
        <div class="tabs">
            <ul class="tab-menu">
                <li><a href="#page-abouts"><span>Imagenes</span></a></li>
                <li><a href="#page-intro"><span>Introducción</span></a></li>
            </ul>

            <!-- Imagenes -->
            <div class="form_inputs" id="page-abouts">
                <fieldset>

                    <?php echo anchor('admin/conocenos/create_image', '<span>+ Nueva imagen</span>', 'class="btn blue"'); ?>
                    <br>
                    <br>
                            ...
                            <tbody>
                                <?php foreach ($images as $image): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo anchor('admin/conocenos/destroy_image/' . $image->id, lang('global:delete'), array('class' => 'btn red small confirm button')) ?>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
            ...
            <div class="form_inputs" id="page-intro">
                <?php echo form_open_multipart(site_url('admin/conocenos/update_intro'), 'id="form-wysiwyg"'); ?>
                <fieldset>
                    <ul>
                        <li>
