...
<section class="item">
    <div class="content">
        <div class="tabs">
            <ul class="tab-menu">
                <li><a href="#page-fundation"><span>Fundación</span></a></li>
            ...
            <div class="form_inputs" id="page-fundation">
                <fieldset>
                    ...
                    <?php echo anchor('admin/fundacion/create_image', '<span>+ Nueva fundación</span>', 'class="btn blue"'); ?>
                    <br>
                    <br>
                            ...
                            <tbody>
                                <?php foreach ($images as $image): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo anchor('admin/fundacion/edit/' . $image->id, lang('global:edit'), 'class="btn green small"'); ?>
                                            <?php echo anchor('admin/fundacion/destroy_image/' . $image->id, lang('global:delete'), array('class' => 'btn red small confirm button')) ?>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
            ...
            <div class="form_inputs" id="page-intro">
                <?php echo form_open_multipart(site_url('admin/fundacion/update_intro'), 'id="form-wysiwyg"'); ?>
                <fieldset>
                    <ul>
                        <li>
