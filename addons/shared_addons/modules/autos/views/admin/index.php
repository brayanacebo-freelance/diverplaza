...
<section class="item">
    <div class="content">
        <div class="tabs">
            <ul class="tab-menu">
                <li><a href="#page-cars"><span>Imagenes</span></a></li>
                <li><a href="#page-intro"><span>Introducción</span></a></li>
            </ul>

            <!-- Imagenes -->
            <div class="form_inputs" id="page-cars">
                <fieldset>

                    <?php echo anchor('admin/autos/create_image', '<span>+ Nueva imagen</span>', 'class="btn blue"'); ?>
                    <br>
                    <br>
                            ...
                            <tbody>
                                <?php foreach ($images as $image): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo anchor('admin/autos/destroy_image/' . $image->id, lang('global:delete'), array('class' => 'btn red small confirm button')) ?>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
            ...
            <div class="form_inputs" id="page-intro">
                <?php echo form_open_multipart(site_url('admin/autos/update_intro'), 'id="form-wysiwyg"'); ?>
                <fieldset>
                    <ul>
                        <li>
