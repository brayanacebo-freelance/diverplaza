<section class="title">
    <h4>Bodegas / Imagenes</h4>
</section>
<section class="item">
    <div class="content">
        <div class="tabs">
            <ul class="tab-menu">
                <li><a href="#page-wineries"><span>Nueva Imagen</span></a></li>
            </ul>
            <div class="form_inputs" id="page-wineries">
                <?php echo form_open_multipart(site_url('admin/bodegas/wineries_image')); ?>
                <div class="inline-form">
                    ...
                    <div class="buttons float-right padding-top">
                        ...
                        <a href="<?php echo backend_url('bodegas') ?>" class="btn red cancel">Cancelar</a>
                    </div>
                </div>
                <?php echo form_close(); ?>
            </div>
